                            ...
                            <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <div className="docs-grid">
                                        ...
                                        <ColorSwatch name="Selected Border" variable="--selected-border-color" description="Brand focused border" />
                                        <ColorSwatch name="Selected Glow" variable="--selected-shadow-glow" description="Primary neon glow for presence" />
